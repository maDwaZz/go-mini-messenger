...
const file_auth_v1_messages_proto_rawDesc = "" +
	"\n" +
	"\x16auth/v1/messages.proto\x12\aauth.v1\"C\n" +
	...
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x12#\n" +
	"\rrefresh_token\x18\x02 \x01(\tR\frefreshToken\x12\x17\n" +
	"\auser_id\x18\x03 \x01(\tR\x06userIdBs\n" +
	"\vcom.auth.v1B\rMessagesProtoP\x01Z\x18proto/api/auth/v1;authv1\xa2\x02\x03AXX\xaa\x02\aAuth.V1\xca\x02\aAuth\\V1\xe2\x02\x13Auth\\V1\\GPBMetadata\xea\x02\bAuth::V1b\x06proto3"
