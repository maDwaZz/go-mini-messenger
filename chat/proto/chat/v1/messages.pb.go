...
const file_chat_v1_messages_proto_rawDesc = "" +
	"\n" +
	"\x16chat/v1/messages.proto\x12\achat.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\x86\x01\n" +
	"\x04Chat\x12\x0e\n" +
	...
	"\x0e_since_unix_msBs\n" +
	"\vcom.chat.v1B\rMessagesProtoP\x01Z\x18proto/api/chat/v1;chatv1\xa2\x02\x03CXX\xaa\x02\aChat.V1\xca\x02\aChat\\V1\xe2\x02\x13Chat\\V1\\GPBMetadata\xea\x02\bChat::V1b\x06proto3"

var (
	file_chat_v1_messages_proto_rawDescOnce sync.Once
	file_chat_v1_messages_proto_rawDescData []byte
)

func file_chat_v1_messages_proto_rawDescGZIP() []byte {
	file_chat_v1_messages_proto_rawDescOnce.Do(func() {
		file_chat_v1_messages_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_chat_v1_messages_proto_rawDesc), len(file_chat_v1_messages_proto_rawDesc)))
	})
	return file_chat_v1_messages_proto_rawDescData
}

var file_chat_v1_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_chat_v1_messages_proto_goTypes = []any{
...
func file_chat_v1_messages_proto_init() {
	...
	file_chat_v1_messages_proto_msgTypes[12].OneofWrappers = []any{}
	file_chat_v1_messages_proto_msgTypes[13].OneofWrappers = []any{}
	file_chat_v1_messages_proto_msgTypes[14].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_chat_v1_messages_proto_rawDesc), len(file_chat_v1_messages_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   0,
